...
public class DataHelper extends SQLiteOpenHelper { // SQLiteOpenHelper untuk memproses SQLite Helper
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // atribut no sebagai primary key artinya data yang tidak boleh sama
        String sql = "CREATE TABLE biodata(no integer PRIMARY KEY, nama text NULL, tgl text NULL, jk text NULL, alamat text NULL);";
        Log.d("Data", "onCreate: " +sql);
        db.execSQL(sql); // mengeksekusi sql
        // buat data
        // sql = "INSERT INTO biodata (no, nama, tgl, jk, alamat) VALUES ('1', 'Fikry Maulana Muzahidin', '2001-07-05', 'Laki-Laki', 'Majalengka');";
        // db.execSQL(sql); // mengeksekusi sql
    }
